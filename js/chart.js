...
function initTradingViewWidget(symbol) {
  ...
  if (sym === "NIFTY_50" || sym === "NIFTY") tvSymbol = "FOREXCOM:IN50";
  else if (sym === "RELIANCE") tvSymbol = "BSE:RELIANCE";
  else if (sym === "TATA_MOTORS" || sym === "TATA") tvSymbol = "BSE:TATAMOTORS";
  else if (sym === "TATA_TECH") tvSymbol = "BSE:TATATECH";
  else if (sym === "BTC_USDT" || sym === "BTC") tvSymbol = "BINANCE:BTCUSDT";
  ...
  else if (sym === "USD_CHF" || sym === "CHF") tvSymbol = "FX:USDCHF";
